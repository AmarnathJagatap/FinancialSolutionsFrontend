...
export default function CreateNewFile() {
  ...
  const [customProduct, setCustomProduct] = React.useState(""); // State to store custom product
    ...
    if (
      ...
      await fetch(Apilink + "/files/createnewfile/", {
        ...
        body: JSON.stringify({
          ...
          product:
            formData.product === "Others" ? customProduct : formData.product,
