            ...
            if(Object.keys(data).length > 0){
              ...
              console.log("Continued to check  Access Token")
                const verifyAccessToken=async()=>{
                  await fetch(`https://financialsolutions.pythonanywhere.com/auth/api/token/verify/`, {
                    method: "POST",
                    body : JSON.stringify({
                       "token":access
                    }),
                    ...
                    if(Object.keys(res).length > 0){
                      console.log("Access Token Expired")
                        const getNewAccessToken=async()=>{
                            await fetch(`https://financialsolutions.pythonanywhere.com/auth/api/token/refresh/`, {
                              method: "POST",
                              body : JSON.stringify({
